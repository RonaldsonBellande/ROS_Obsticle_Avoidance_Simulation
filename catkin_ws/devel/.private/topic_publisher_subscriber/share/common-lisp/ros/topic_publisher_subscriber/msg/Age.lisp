...
(cl:defmethod cl:initialize-instance :after ((m <Age>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Age)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name topic_publisher_subscriber-msg:<Age> is deprecated: use topic_publisher_subscriber-msg:Age instead.")))

(cl:ensure-generic-function 'years-val :lambda-list '(m))
(cl:defmethod years-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader topic_publisher_subscriber-msg:years-val is deprecated.  Use topic_publisher_subscriber-msg:years instead.")
  (years m))

(cl:ensure-generic-function 'months-val :lambda-list '(m))
(cl:defmethod months-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader topic_publisher_subscriber-msg:months-val is deprecated.  Use topic_publisher_subscriber-msg:months instead.")
  (months m))

(cl:ensure-generic-function 'days-val :lambda-list '(m))
(cl:defmethod days-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader topic_publisher_subscriber-msg:days-val is deprecated.  Use topic_publisher_subscriber-msg:days instead.")
  (days m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Age>)))
  ...
  "topic_publisher_subscriber/Age")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Age)))
  "Returns string type for a message object of type 'Age"
  "topic_publisher_subscriber/Age")
